...
// Extract dropdown options from the tags
...
// Generate range options for white balance fine tune
...
// Get color saturation options with only numerical values
const getColorSaturationOptions = () => {
  ...
  return Object.entries(saturationTag.values)
    .filter(([, value]) => {
      // Only include options that have numerical values like +2, -1, etc.
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Configure your Fujifilm camera settings to create a custom recipe.
        </CardDescription>
      </CardHeader>
      <CardContent>
